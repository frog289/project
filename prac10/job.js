function showMessage() {
 ...
 // alert(message);  Ошибка
  ...
  const user1 = new User("Кирилл");
  user1.displayUserName(); // Имя пользователя: Кирилл
  ...
  const greeter = new Greeter('Кирилл');//Привет Кирилл
  greeter.showMessage();
  ...
  const reverser = new NameReverser("Кирилл Борисов");
  console.log(reverser.reverseName()); // восироБ ллириК
